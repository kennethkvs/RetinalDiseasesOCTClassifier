...
Upon loading the images, each image was labeled with an integer to represent its corresponding disease. The images were already named as DISEASE-\#\#\#\#\#-\#.jpeg and binned in the correct folders, which allowed for ease of labeling. The numbers for their corresponding disease is shown below:
...
Adding onto this, we transformed the data by randomly flipping them horizontally. This allowed for the training set to have a more robust and diverse dataset. This is technically not considered an augmentation since we did not create new data.
