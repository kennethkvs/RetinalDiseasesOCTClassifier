...
\begin{center}
    \includegraphics[width=1\linewidth]{Images/CNV_final.png}
    \captionsetup{hypcap=false}
    \captionof{figure}{Confusion Matrix for CNV class.}
    \label{fig:matrix_cnv}
\end{center}

\begin{center}
    \includegraphics[width=1\linewidth]{Images/DME_final.png}
    \captionsetup{hypcap=false}
    \captionof{figure}{Confusion Matrix for DME class.}
    \label{fig:matrix_dme}
\end{center}

\begin{center}
    \includegraphics[width=1\linewidth]{Images/DRUSEN_final.png}
    \captionsetup{hypcap=false}
    \captionof{figure}{Confusion Matrix for DRUSEN class.}
    \label{fig:matrix_drusen}
\end{center}

\begin{center}
    \includegraphics[width=1\linewidth]{Images/NORMAL_final.png}
    \captionsetup{hypcap=false}
    \captionof{figure}{Confusion Matrix for NORMAL class.}
